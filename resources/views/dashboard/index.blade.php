...
<div class="mb-5 flex items-start gap-4 bg-red-50 border border-red-200 rounded-xl p-4 shadow-sm">
    ...
    <div class="flex-1 min-w-0">
        <p class="text-sm font-semibold text-red-800">
            Alerte paiement — {{ ucfirst($alarme_paiement['mois']) }}
        </p>
...
<div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 mb-6">
    ...
    <div class="bg-blue-500 text-white rounded-xl p-5 shadow-md">
        <div class="flex items-center justify-between mb-3">
            <div>
                <p class="text-sm font-medium opacity-90">Eleves</p>
    ...
    <div class="bg-purple-500 text-white rounded-xl p-5 shadow-md">
        <div class="flex items-center justify-between mb-3">
            <div>
                <p class="text-sm font-medium opacity-90">Paiements</p>
    ...
    <a href="{{ route('impayes') }}" class="text-white rounded-xl p-5 shadow-md transition-colors cursor-pointer block" style="background-color: #ef4444;" onmouseover="this.style.backgroundColor='#dc2626'" onmouseout="this.style.backgroundColor='#ef4444'">
        <div class="flex items-center justify-between mb-3">
            <div>
        ...
        <span class="text-xs text-red-100 hover:text-white">Voir la liste &rarr;</span>
    </a>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
        <div class="flex items-center justify-between mb-4">
            <h3 class="font-semibold text-gray-800">Derniers Etudiants</h3>
        ...
        <table class="w-full text-sm">
            <thead>
                <tr class="text-left text-gray-400 text-xs border-b border-gray-100">
                    ...
                    <th class="pb-2 font-medium">Telephone</th>
                </tr>
            </thead>
            <tbody class="divide-y divide-gray-50">
                ...
                @empty
                <tr><td colspan="3" class="py-4 text-center text-gray-400 text-sm">Aucun etudiant enregistre</td></tr>
                @endforelse
            </tbody>
        </table>
    ...
    <div class="space-y-4">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            <div class="flex items-center justify-between mb-3">
                <h3 class="font-semibold text-gray-800">Paiements Recents</h3>
                <a href="{{ route('paiements.index') }}" class="text-xs text-blue-600 hover:underline">Voir tout</a>
            </div>
            <table class="w-full text-sm">
                <thead>
                    <tr class="text-left text-gray-400 text-xs border-b border-gray-100">
                        <th class="pb-2 font-medium">Eleve</th>
...
{{-- GRAPHIQUE --}}
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
    <h3 class="font-semibold text-gray-800 mb-4">Statistiques de l'annee {{ now()->year }}</h3>
